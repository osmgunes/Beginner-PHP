...
<form action="kitapkaydet.php" method="post" value=kitap> 
...
<td>
 ...
 <td>
  <input type="text" name="tur" size="40">
  </td>
  </tr>
  <tr>
  <td>
 ...
 <td>
  <input type="text" name="adet" size="40">
  </td>
</tr>
...
<tr>
 <td colspan = "2">
 <div align="right"> 
 <input type="submit" value="  KAYDET  "></div>
 <td>
 </tr>
</form>
